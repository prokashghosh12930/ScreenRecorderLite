...
```
cd existing_repo
git remote add origin https://gitlab.com/prokash447/overlayrecorder.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/prokash447/overlayrecorder/-/settings/integrations)
